...
public class Generator {
  ...
  void writeAbout() throws IOException {
    ...
    writer.text("specification. It also contains some references to the HTML version of ");
    ...
    for (Library lib: model.getLibraries()) {
      writer.markup("<li><a href='").text(lib.getName() + " - Overview.html").markup("'>");
      writer.text(lib.getName());
      writer.markup("</a></li>\n");
      writeLibrary(lib);
    }
  ...
  public static void main(String[] args) throws IOException {
    ...
    HtmlWriter.copyFile("res/static/index.html", "gen/index.html");

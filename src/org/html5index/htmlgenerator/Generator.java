...
public class Generator {
  ...
  public void writeLibrary(Library lib) throws IOException {
    ...
    writer.markup("<h3>Sources</h3>");
    writer.text("The index for this library is generated from the following specification documents:");
    writer.markup("</p><ul>");
    ...
    writer.markup("<h3>IDL Source</h3>");
    writer.markup("<pre>");
    writer.text(lib.getDocumentationProvider().getIdl());
    writer.markup("</pre>");
  ...
  void writeAboutContent(HtmlWriter writer, boolean inFrame) throws IOException {
    ...
    writer.text("IDL fragments from the WHATWG DOM specification and the WHATWG HTML 5 ");
    writer.text("specification using the ");
    writer.markup("<a href='https://github.com/stefanhaustein/html5index' target='_top'>html5index</a>");
    writer.text(" github project. It also contains references to the HTML version of ");
    writer.text("the ECMAScript specification.");
    writer.markup("</p><p>\n");
    
    if (inFrame) {
      writer.text("This reference uses HTML frames. If you don't see the index of libraries ");
      ...
      writer.text("This reference uses HTML frames, but your browser does not seem ");
